...
# Load the Muon Analyzer.
process.load("my_EDAnalyzers.Muon_Analyzer.muonAnalyzer_cff")
#process.muonAnalyzer.testBool = cms.bool(False)

# Attach the FileService module to the process to output ROOT files.
process.TFileService = cms.Service("TFileService", fileName=cms.string("mymuons.root"))
