...
process.my_electrons = cms.EDAnalyzer('Electron_Analyzer',
                        electrons = cms.InputTag("slimmedElectrons"),
                        vertices = cms.InputTag("offlineSlimmedPrimaryVertices")
)

# Attach the FileService module to the proces.
process.TFileService = cms.Service("TFileService", fileName=cms.string("myelectrons.root"))

if isData:
    process.p = cms.Path(process.my_electrons)
else:
    process.p = cms.Path(process.my_electrons)
